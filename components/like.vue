...
defineProps({
    id: {
        type: Number,
        required: true, // required to avoid potential errors
    }
});

const store = productsStore()
let check = ref(false); // initialize based on store
...
<template>
    <div class="heart-container" title="Like">
        <input type="checkbox" :v-model="check" @click="toggleFavourite()" class="checkbox" id="Give-It-An-Id">
